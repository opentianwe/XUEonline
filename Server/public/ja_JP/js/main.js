...
(function ($) {
  ...
  $(".list-items>li")
    .eq(1)
    .html(
      '<span class="fas fa-envelope mrr-10 text-primary-color"></span>haominjiaoyu@126.com'
    );
  $(".list-items>li").eq(2).hide();
  $(".list-items>li").eq(0).html("");
  $(".address").html(
    '<i class="webexflaticon flaticon-placeholder-1"></i>管理員skype ID'
  );
  ...
  $(".footer-widget-list>li")
    .eq(5)
    .html('<a href="../zp.html" target="_blank">先生になる</a>');
  $(".navbar-brand").html(
  ...
  $(".right-view>li")
    .eq(0)
    .html('<a href="./teacherdata.html">教师资料填写入口</a>')
    .hide();
  $(".right-view>li")
    .eq(1)
    .html('<a href="./teacherdata.html">教师资料填写入口</a>')
    .hide();
  $(".sub-menu>.has-sub-child").html(
    '<li><a href="./teacherdata.html">先生情報修正</a></li>'
  );
  $(".sub-menu>li").eq(5).html('<a href="./logoin.html">ログイン</a>');
  $("#qiut-s").attr("href", "javascript:;");
  $("#qiut-s").attr("onclick", "clearCookie()");
  $(".phone").html(
    '<a style="display:inline" href="skype:live:.cid.95a072e4c57d6976?add">live:.cid.95a072e4c57d6976</a>'
  );
  $(".footer-widget-list>li")
    .eq(11)
    .html('<a href="./snewtit.html" target="_blank">ご利用規約</a>');
  console.log(
    $(".widget-title")
      .eq(1)
