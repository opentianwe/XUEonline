...
class PayoutsItemCancelRequest {
  ...
  constructor(payoutItemId) {
    this.path = '/v1/payments/payouts-item/{payout_item_id}/cancel?';
    this.path = this.path.replace('{payout_item_id}', querystring.escape(payoutItemId));
    this.verb = 'POST';
    this.body = null;
    this.headers = {
...
module.exports = {PayoutsItemCancelRequest: PayoutsItemCancelRequest};
