// This class was generated on Thu, 19 Dec 2019 11:59:51 IST by version 0.1.0-dev+904328-dirty of Braintree SDK Generator
// payoutsGetRequest.js
...
class PayoutsGetRequest {
  ...
  constructor(payoutBatchId) {
    this.path = '/v1/payments/payouts/{payout_batch_id}?';
    this.path = this.path.replace('{payout_batch_id}', querystring.escape(payoutBatchId));
    this.verb = 'GET';
    this.body = null;
    this.headers = {
...
module.exports = {PayoutsGetRequest: PayoutsGetRequest};
